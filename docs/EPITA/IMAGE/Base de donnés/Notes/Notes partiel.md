...
### Approche Prédictive (Cascade/Waterfall)
...
- **Contraintes** :
    - Techniques : environnement cible.
...
- Décomposition hiérarchique de TOUT le travail à faire.
...
- Connaître les principales stratégies de réponse.
